                ...
                <nav class="header__navbar--elm">
                        <ul class="header__navbar-list">
                            ...
                            <li class="header__navbar-item">
                                <a href="Views/Client/gioithieu.php" class="header__navbar-item-link">Giới thiệu</a>
                            </li>
                            <li class="header__navbar-item">
                        ...
                        <li class="menu_nav-text">
                            ...
                            <i class ="ti-angle-down"></i>
                                <ul class="subnav">
                                  ...
                                  ?>
                                <li class="menu-item"><a href="?redirect=product"><?= $item['cat_name'] ?></a></li>
                                  <?php } ?>
                                </ul>
                        </li>
                        
                        <li>
                          <a class ="menu__navbar-menu-item" href="Views/Client/tknt.php">THIẾT KẾ NỘI THẤT</a>
                        </li>
                        <li>
